            ...
            <Col {...sizedContent} >
                <Card title={'Design Mock'}>
                    <Form onSubmit={handleSubmit} record={(params && records.length === 1) ? records[0] : initialRecord}>
                        ...
                        <FormItem fieldType={'object'} label='Headers' dataIndex={'headers'} style={inlineStyled}/>

                        <FormItem fieldType={'object'} label='Body' dataIndex={'response'} style={inlineStyled}/>
