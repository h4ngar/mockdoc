...
export const NewMock = () => {
    ...
    const handleSubmit = async (data, form) => {
        ...
        if (form.requestHeaders !== '' && typeof form.requestHeaders !== 'undefined') {
            try {
                JSON.parse(form.requestHeaders)
            } catch (e) {
                return message.error('Request Headers must be an object');
            }
        }

        if (form.requestBody !== '' && typeof form.requestBody !== 'undefined') {
            try {
        ...
        if (form.responseHeaders !== '' && typeof form.responseHeaders !== 'undefined') {
            try {
