...
export const NewMock = () => {
    ...
    const handleSubmit = async (data, form) => {
        try {
            if (typeof form.responseHeaders !== 'undefined' && form.responseHeaders !== '') {
                form.responseHeaders = JSON.parse(form.responseHeaders);
            }

            if (typeof form.requestHeaders !== 'undefined' && form.requestHeaders !== '') {
                form.requestHeaders = JSON.parse(form.requestHeaders);
            }

            if (typeof form.requestBody !== 'undefined' && form.requestBody) {
                form.requestBody = JSON.parse(form.requestBody);
            }

            if (typeof form.requestBody === 'undefined' || form.requestPath.isAutoGenerated) {
                form.requestPath = {
                    path: '/' + nanoid(),
